      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Reses</span> </h4>
        ...
        <tbody>
            ...
            <?php foreach($goal as $key => $g):?>
                ...
                <td><?php echo $g['resName'];?></td>
                <td><?php echo $g['residenceId'];?></td>
                <td><?php echo $g['address'];?></td>
                <td><?php echo $g['location'];?></td>
                <td><?php echo $g['rooms'];?></td>
                <td><?php echo $g['singlesRoom'];?></td>
                <td><?php echo $g['doubleRoom'];?></td>
                <td><?php echo $g['buses'];?></td>
                <td><?php echo $g['extras'];?></td>
                <td><?php echo $g['rules'];?></td>
                <td><?php echo $g['contact'];?></td>
                <td><?php echo $g['date_created'];?></td>
                <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href=""
                                ><i class="bx bx-edit-alt me-2"></i> View Res</a
                              >
