      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Students</span> </h4>
        ...
        <tbody>
            ...
            <?php foreach($goal as $key => $g):?>
                ...
                <td><?php echo $g['studentNumber'];?></td>
                <td><?php echo $g['degree'];?></td>
                <td><?php echo $g['levelOfStudy'];?></td>
                <td><?php echo $g['degreeCode'];?></td>
