            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Activate Account Password</h5>
                ...
                <i id="hide4"class="fa fa-eye-slash" aria-hidden="true"></i>
                    ...
                    <br>
                    <div class="col-12"><br>
                      <button class="btn btn-primary w-100" type="submit" name="activate-btn">Activate Account</button>
                    </div>
