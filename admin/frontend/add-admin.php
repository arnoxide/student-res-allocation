            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">theboxlab</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Add Admin user 🚀</h4>
             

              <form id="formAuthentication" class="mb-3" action="" method="POST">
                <?php require_once '../database/flash-messages.php';?>
                <div class="mb-3">
                ...
                <button name="signup-btn" type="submit" class="btn btn-primary d-grid w-100">Create Account</button>
