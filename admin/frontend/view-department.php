  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <?php
// $sql = "SELECT * FROM team_reports JOIN staff_members WHERE staff_members_tbl.team_member_id=team_reports.uid WHERE dept_id='$id'";
$sql = "SELECT * FROM team_reports JOIN staff_members_tbl WHERE staff_members_tbl.team_member_id=team_reports.uid AND dept_id='$id'";
            ...
            <tr>
                ...
                <td><a href="../reports/<?php echo $row['file'];?>"><?php echo $row['file'];?></td></a>
