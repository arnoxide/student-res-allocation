...
if (isset($_GET['resetToken'])) {
  ...
  if (isset($_GET['activateToken'])) {
    ...
    validateaccountToken($activateToken,$base_url);
  }
?> 
<!DOCTYPE html>
<html
...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="assets/img/favicon/fav.jpg" />
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">thebox</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <?php include 'database/flash-messages.php';?>
                <div class="mb-3">
                  ...
                  <input
                    ...
                    autofocus value="<?php echo $email;?>"
                  />
                </div>
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" name="login-btn" type="submit">Sign in</button>
                </div>
