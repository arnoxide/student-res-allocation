...
<body>
    ...
    <a class="dropdown-item approve-action" href="#" data-student-number="<?php echo $application['studentNumber']; ?>">Approve</a>
    <a class="dropdown-item reject-action" href="#" data-student-number="<?php echo $application['studentNumber']; ?>">Reject</a>
    <a class="dropdown-item waiting-action" href="#" data-student-number="<?php echo $application['studentNumber']; ?>">Waiting List</a>
</div>
