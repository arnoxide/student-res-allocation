...
<html lang="en">
<head>
    <title>Univen Res Allocation</title>
    <meta charset="utf-8">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <h3 class="text-center mb-4">Use Student Number and Pin</h3>
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="login-form">
                            <div class="form-group">
                                <input type="text" name="studentNumber" class="form-control rounded-left" placeholder="Student Number" required>
                            </div>
